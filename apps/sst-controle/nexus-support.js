(() => {
  ...
  style.textContent = `
    .nexus-support-root,.nexus-support-root *{box-sizing:border-box}
    ...
    .nexus-support-trigger{display:inline-flex;align-items:center;justify-content:center;gap:8px;width:auto;min-height:46px;margin:0;padding:0 16px;border:1px solid rgba(224,184,74,.52);border-radius:999px;background:linear-gradient(180deg,#111a1f,#0b1419);color:#f5eee0;font:700 13px/1 Inter,"Segoe UI",Arial,sans-serif;box-shadow:0 14px 38px rgba(0,0,0,.32);cursor:pointer}
    ...
    .nexus-support-head strong{display:block;font-size:15px}.nexus-support-head span{display:block;margin-top:5px;color:#98a2a7;font-size:11px;line-height:1.45}.nexus-support-close{width:auto;margin:0;padding:4px;border:0;background:transparent;color:#c7ced1;font:700 11px/1 Inter,"Segoe UI",Arial,sans-serif;cursor:pointer}

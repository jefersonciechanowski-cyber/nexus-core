(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .nexus-cookie-card{width:min(760px,100%);display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:18px;padding:14px 16px;border:1px solid #42545c;border-radius:13px;background:#0a151a;color:#f3efe5;box-shadow:0 24px 80px rgba(0,0,0,.58);pointer-events:auto}
      ...
      banner.innerHTML = `
        <div class="nexus-cookie-card">
          <div class="nexus-cookie-copy">
            <strong id="nexusCookieTitle">Cookies e privacidade</strong>
            <p>Usamos cookies opcionais da Meta para medir visitas e melhorar nossas campanhas. Você pode aceitar ou recusar. <a href="privacidade.html">Saiba mais</a>.</p>
          </div>
